...
struct run_bfs
{
  void operator() () 
  {
    ...
    {
      VertexSubset<int> *  output = edgeset_apply_pull_serial_from_vertexset_to_filter_func_with_frontier(edges, frontier, toFilter(), updateEdge()); 
...
{
  edges = builtin_loadEdgesFromFile ( "../../test/graphs/4.el") ;
...
/*  0 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // struct run_bfs
};

_CFFI_UNUSED_FN
static void _cffi_checkfld_struct_run_bfs(struct run_bfs *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
}
struct _cffi_align_struct_run_bfs { char x; struct run_bfs y; };

static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "run_bfs", 0, _CFFI_F_CHECK_FIELDS,
    sizeof(struct run_bfs), offsetof(struct _cffi_align_struct_run_bfs, y), 0, 0 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__simplebfs_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__simplebfs_cffi(void) { return NULL; }
#  else
     init_simplebfs_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__simplebfs_cffi(void)
{
  return _cffi_init("_simplebfs_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_simplebfs_cffi(void)
{
  _cffi_init("_simplebfs_cffi", 0x2601, &_cffi_type_context);
}
#endif
